...
import { deleteTasks, updateTask } from "../features/workspaceSlice";
                            ...
                            <tbody>
                                {filteredTasks.length > 0 ? (
                                    filteredTasks.map((task) => {
                                        ...
                                        return (
                                            <tr key={task.id} onClick={() => navigate(`/projects/${task.project || task.projectId}/tasks/${task._id || task.id}`)} className=" border-t border-zinc-300 dark:border-zinc-800 group hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-all cursor-pointer" >
